...
public class RepaymentService {
    ...
    public Repayment recordRepaymentTransaction(RepaymentRequest repaymentRequest) {
        ...
        repayment.setAmount(new BigDecimal(repaymentRequest.getAmount()));
    ...
    public Repayment makeRepayment(Long loanId, BigDecimal amount) {
        ...
        if (loanOpt.isPresent()) {
            ...
            RepaymentRequest paymentRequest = new RepaymentRequest();
            paymentRequest.setLoanId(loanId);
            paymentRequest.setPhoneNumber(loan.getPhoneNumber());
            paymentRequest.setAmount(amount.toString());
            ...
            HttpEntity<RepaymentRequest> requestEntity = new HttpEntity<>(paymentRequest, headers);
